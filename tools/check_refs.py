...
APPENDIX_ZH = os.path.join(BASE, "book", "19-附录A-案例索引与资料出处.md")
APPENDIX_EN = os.path.join(BASE, "book-en", "19-appendix-a-sources.md")
ZH_BODY = ["01-第1章-买家换了入口.md","02-第2章-决策在暗漏斗里完成.md","03-第3章-候选集机制.md",
           "04-第4章-GEO原理动作与度量.md","05-第5章-两套规则.md","06-第6章-一手数据与验证经济.md",
           "07-第7章-机器可读.md","08-第8章-第三方信源与人类痕迹.md","09-第9章-风险话题即入口.md",
           "10-第10章-触达军备竞赛.md","11-第11章-外联外呼与合规.md","12-第12章-五档标签与账户智能.md",
           "13-第13章-当客户是机器.md","14-第14章-怎么知道有用.md","15-第15章-入口依赖与对冲.md",
           "16-第16章-谁来做.md","17-第17章-边界与失败档案.md"]
EN_BODY = []
